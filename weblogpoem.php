...
$query1 = "SELECT * FROM poem INNER JOIN users  ON poem.userid = users.userid AND users.userid=$user_id AND id=$id1";
...
<html>
    ...
    <div class="shadow-sm p-3 mb-5 bg-white rounded">
      <div class="card-body" ><?php $row1 = mysqli_fetch_array($result1);?>
        <h5 class="card-title"><?php echo $row1['headname']?></h5>
        <pre class="card-text" ><?php echo $row1['text1']?></pre>
        <p class="card-text"><small class="text-muted">Uploaded on: <?php echo $row1['datee']?></small></p>
      </div>
    </div>
                </div></div>
    ...
    <div class="shadow-sm p-3 mb-5 bg-white rounded">
      <div class="card-body">
        <h5 class="card-title"><?php 
            ...
            ?><?php echo $bas?></h5>
        <p class="card-text"><?php echo $row1['text2']?></p>
